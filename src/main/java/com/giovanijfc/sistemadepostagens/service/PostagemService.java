...
public class PostagemService {
	...
	public PostAndTopico add(Postagem postagem, Integer id) {
		...
		Postagem postagem1 = new Postagem(null, postagem.getTexto(), sdf.format(new Date(System.currentTimeMillis())),
	...
	public Resposta addResposta(Resposta resposta, Integer id) {
		Usuario u1 = usuarioRepo.findById(id).orElse(null);
		Resposta resposta1 = new Resposta(null, resposta.getTexto(), sdf.format(new Date(System.currentTimeMillis())),
				sdff.format(new Date(System.currentTimeMillis())), u1, TipoPostagem.RESPOSTA);
		return resposta1;
	}
